...
function Header ({ siteTitle }) {
  ...
  return (
    ...
    <div className={clsx('w-full mx-auto max-w-7xl px-2 sm:px-6 lg:px-8')}>
        <div className={clsx('flex h-16 justify-between')}>
          <div className={clsx('flex justify-self-start')}>
          
            <div className={clsx('hidden sm:flex sm:space-x-8')}>
